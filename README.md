...
6. Phyrion, 「0-Y 与 BMS：可逆性、序同构及良序性」（0-Y の整列性と Lean 4 による形式化）. [GitHub](https://github.com/Phyrion1343/0Y-Well-Ordering-Lean)
7. Phyrion, "Well-Ordering of the 1-Y Sequence System"（1-Y の整列性と Lean 4 による形式化）. [GitHub](https://github.com/Phyrion1343/1Y-Well-Ordering-Lean)
