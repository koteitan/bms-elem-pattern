...
証明に使う数学を、定義と小さい例から順に説明したノート。上から順に読める。

| ノート | 内容 |
|---|---|
| [01 順序数と ω₁](01-ordinals.md) | 無限降下列、後続で閉じる、可算順序数、ω₁ の正則性 |
| [02 構造と初等部分構造](02-elementary-substructure.md) | 論理式、上下への保存、Σₙ 初等部分構造、コピー、Lean での論理式の表し方 |
| [03 R_N](03-patterns.md) | 定義、なぜ定義できるか、基本性質、小さい例、文献の結果 |
| [04 R_N の性質 P1〜P7](04-pattern-properties.md) | 有限反映に使う 7 つの性質 |
| [05 配列、展開、安定ラベル](05-arrays-labels.md) | 親と祖先、展開、標準列、ラベルの体系、命題 19.1 |
| [06 有限反映](06-finite-reflection.md) | n = 0, 1, 2 の証明 |
| [07 ω₁ の中の閉包と鎖](07-closure-chains.md) | next、λ、すべての段で結ばれた鎖 |
| [08 停止性と整礎性](08-termination.md) | 初期列のラベル、停止性、整礎性、ラベルの大きさ |
